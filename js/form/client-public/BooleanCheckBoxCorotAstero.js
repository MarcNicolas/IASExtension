 ...
 */
sitools.common.forms.components.BooleanCheckboxCorotAstero = Ext.extend(Ext.Container, {
	...
	if (Ext.isArray(this.defaultValues) && this.defaultValues.length == 4) {
	    ...
	    sitools.common.forms.components.BooleanCheckboxCorotAstero.superclass.initComponent.apply(
	            this, arguments);
